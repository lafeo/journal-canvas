...
export default function Toolbar() {
  const { mode, setMode, graphData, folderPath, setFolderPath, setIsReady, apiKey, setApiKey } = useAppStore()
    ...
    <div className="toolbar">
      ...
      <div className="toolbar-center">
        <div className="mode-toggle">
          <button
            className={`mode-btn ${mode === 'entity' ? 'active' : ''}`}
      ...
      <div className="toolbar-right">
        <div className="stats">
          ...
          <span className="stat"><span className="stat-dot doc-dot" />{stats.docs} docs</span>
        </div>
        <button className="btn-ghost" onClick={handleReprocessAll} title="Re-analyse all files">↻</button>
